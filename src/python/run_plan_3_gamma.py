...
from inference_core.ks_tools import empirical_cdf, bootstrap,bootstrap_normal_step, partial_cdf_at_point, get_dstar,  ks_distance, bootstrap_gamma_step
...
ro =ks_distance(b_d_stars, d_star_real)
